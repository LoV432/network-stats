    ...
    fetch("./stats.json")
        ...
        .then(function (data) {
            ...
            for (i = 0; i < 10; i++) {
                ...
                document.getElementsByClassName("rt")[i].innerHTML = input[1];
                document.getElementsByClassName("rd")[i].innerHTML = input[3];
                document.getElementsByClassName("ru")[i].innerHTML = input[4];
                document.getElementsByClassName("rs")[i].innerHTML = input[2];
